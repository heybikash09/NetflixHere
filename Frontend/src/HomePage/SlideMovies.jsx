...
function SlideMovies() {
  ...
  return (
    <>
    {loading?<PulseMainVideo/>:<div className="w-[95%] mx-auto h-screen px-4 p-10  ">
        <Swiper
          ...
          {trendingContent.map((src, index) => (
            <SwiperSlide key={index}>
              <div className=" h-full bg-gradient-to-r from-black via-slate-700 to-slate-400">
                ...
                />
                <div className="  relative z-50 -top-[65%] py-5 flex flex-col gap-5 ml-20 text-white">
                  ...
                  <div className="flex w-[20%] md:w-[20%] lg:w-[18%] text-xl text-slate-300  font-semibold  justify-start gap-2">
                    <li>{contentType=='movie'?src.release_date:src.first_air_date}</li>
                    <span>|</span>
                  </div>
